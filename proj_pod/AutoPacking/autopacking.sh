...
# 【配置上传到蒲公英相关信息】(可选)
__PGYER_U_KEY="b594f2471d68448734348b5388b54487"
__PGYER_API_KEY="b44c678bf81cad43f57807046746e947"

# 【配置上传到 Fir】(可选)
__FIR_API_TOKEN="fafcfd2a8d2534488818f3e5337d3eb5"
...
# 1. 请选择 SCHEME
#__SELECT_TARGET_OPTIONS=("1.AppicPlayDemoTestCase")
#READ_USER_INPUT "请选择对应的Target: " "${__SELECT_TARGET_OPTIONS[*]}" ${#__SELECT_TARGET_OPTIONS[*]}

  __BUILD_TARGET="KATrackingAdDemo"
  __SCHEME_NAME="KATrackingAdDemo"

#__SELECT_TARGET_OPTION=$?
#if [[ $__SELECT_TARGET_OPTION -eq 1 ]]; then
#  __BUILD_TARGET="AppicPlayDemoTestCase"
#  __SCHEME_NAME="AppicPlayDemoTestCase"
#else
